  ...
  return (
    <div>
      <button
        ...
        style={{ width: '300px', height: '80px', fontSize: '24px', padding: '0 20px', overflow: 'hidden', bottom: '30px', right: '20px', borderRadius: '50px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', backgroundColor: '#D204D6', borderColor: '#D204D9'}}
        onClick={togglePanel}
      > 
